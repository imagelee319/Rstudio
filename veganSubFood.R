...
vegan_raw <- read_excel("C:/Rstudy/0506/newProj/rvd.xls") #vegan
...
veg_alt<-ggplot(alf_group_df_p, aes(x = answers, y=value, fill = name)) + 
  ...
  ggtitle("Vegan: Alternative food", subtitle = "vegan") + 
